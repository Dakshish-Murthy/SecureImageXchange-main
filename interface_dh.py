...
class ImageEncryptorApp:
    ...
    def get_password(self, c):
        if c == "1":
            with open('/home/anish/Downloads/SecureImageXchange-main/alice-shared-key.txt','rb') as file:
                password=file.read()
        else:
            with open('/home/anish/Downloads/SecureImageXchange-main/bob-shared-key.txt','rb') as file:
                password=file.read()
